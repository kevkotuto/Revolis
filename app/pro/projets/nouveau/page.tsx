...
import { ArrowLeft, BuildingIcon, Calendar, Users, BadgeDollarSign, X, Plus, RefreshCw } from 'lucide-react';
...
import { ExchangeRate, Client, ProjectPart, Prestataire } from '@/types';
...
export default function NouveauProjetPage() {
  ...
  // Chargement des clients, prestataires et taux de change
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/pro/projets/${newProject.id}`);
    } catch (error: any) {
      console.error('Erreur:', error);
